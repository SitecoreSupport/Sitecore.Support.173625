...
namespace Sitecore.Support.DataExchange.Providers.DynamicsCrm.Local.Commands
{
    [Serializable]
    public class CreateTenantCommand : Command
    {
        ...
        protected void Run(ClientPipelineArgs args)
        {
            ...
            if (!args.IsPostBack)
            {
                Sitecore.Context.ClientPage.ClientResponse.Input(Translate.Text(Sitecore.DataExchange.Providers.DynamicsCrm.Local.Texts.ItemNamePromptForNewTenant), branchItem.DisplayName, Sitecore.Configuration.Settings.ItemNameValidation, "'$Input' is not a valid name.", 100);
